...
import { createAdobeIoApiClient } from "#io-console/index";
import { TEST_ADOBE_IO_EVENTS_HTTP_CLIENT_PARAMS } from "#test/fixtures/http-client-params";
import { ADOBE_IO_CONSOLE_API_PAYLOADS } from "#test/fixtures/io-console-payloads";
...
describe("Adobe I/O Console API - Integration test", () => {
  ...
  describe.each(ADOBE_IO_CONSOLE_API_PAYLOADS)("$name", (payload) => {
