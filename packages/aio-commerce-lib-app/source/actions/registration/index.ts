 ...
 *
 * As of the v2 Admin UI SDK mass actions, this action is no longer generated by
 * the SDK — the `adminUi` block is served through the `app-config` action
 * instead. It is retained for API compatibility and manual use.
 *
