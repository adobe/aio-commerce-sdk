 ...
 */
export async function createCommerceEvents(
 ...
 * @param context - The execution context for the events installation.
 */
export async function removeCommerceEvents(
  config: CommerceEventsConfig,
  context: EventsExecutionContext,
) {
  const { logger } = context;
 ...
 * @param context - The execution context for the events installation.
 */
export async function createExternalEvents(
 ...
 * @param context - The execution context for the events installation.
 */
export async function removeExternalEvents(
  config: ExternalEventsConfig,
  context: EventsExecutionContext,
) {
  const { logger } = context;
