# `@adobe/aio-commerce-lib-config`: `v1.8.0`
...
| [BusinessConfigSchema](type-aliases/BusinessConfigSchema.md)                     | A business configuration schema as the developer writes it.                                           |
| [BusinessConfigSchemaField](type-aliases/BusinessConfigSchemaField.md)           | A single static configuration field (one of: list, text, password, email, url, phone, boolean).       |
| [BusinessConfigSchemaListOption](type-aliases/BusinessConfigSchemaListOption.md) | A single option in a `list` configuration field.                                                      |
| [BusinessConfigSchemaValue](type-aliases/BusinessConfigSchemaValue.md)           | Supported default value types across all business configuration schema fields.                        |
...
| [InitializeAsyncOptions](type-aliases/InitializeAsyncOptions.md)                 | Options for initializing the configuration library with a schema that may require runtime resolution. |
...
| [SelectorByCommerceScopeId](type-aliases/SelectorByCommerceScopeId.md)           | Selector type for identifying a system scope by its Commerce API ID.                                  |
...
| [byStoreId](functions/byStoreId.md)                                     | Creates a scope selector that identifies a store (store group) by its Commerce API ID.                                           |
| [byStoreViewId](functions/byStoreViewId.md)                             | Creates a scope selector that identifies a store view by its Commerce API ID.                                                    |
| [byWebsiteId](functions/byWebsiteId.md)                                 | Creates a scope selector that identifies a website by its Commerce API ID.                                                       |
