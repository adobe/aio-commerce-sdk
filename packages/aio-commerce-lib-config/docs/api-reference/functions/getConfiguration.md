...
Defined in: [packages/aio-commerce-lib-config/source/config-manager.ts:302](https://github.com/adobe/aio-commerce-sdk/blob/0a288d7c5e68ff4da901f82cbda502430799502f/packages/aio-commerce-lib-config/source/config-manager.ts#L302)
