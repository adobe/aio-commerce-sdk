...
Defined in: [packages/aio-commerce-lib-config/source/config-manager.ts:302](https://github.com/adobe/aio-commerce-sdk/blob/6b16d0bd0d47b3f7207ca2bc8c7b54931221ca0c/packages/aio-commerce-lib-config/source/config-manager.ts#L302)
