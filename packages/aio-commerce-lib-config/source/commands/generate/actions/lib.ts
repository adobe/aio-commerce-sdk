...
function buildOperations(extConfig: Document) {
  process.stdout.write("📝 Building operations...\n");
...
function buildRuntimeManifest(extConfig: Document) {
  process.stdout.write("📝 Building runtime manifest...\n");
...
async function buildHooks(extConfig: Document) {
  process.stdout.write("📝 Building hooks...\n");
  ...
  if (prevValue !== "" && !prevValue.includes(command)) {
