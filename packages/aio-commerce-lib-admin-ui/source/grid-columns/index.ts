...
/** biome-ignore-all lint/performance/noBarrelFile: This is the public API for the grid-columns entrypoint. */

/**
 * Builders for the `commerce/backend-ui/2` grid column wire contract.
 *
 * Provides request parsing and response envelope construction for runtime
 * actions registered under `adminUi.<grid>.gridColumns.runtimeAction`.
 *
