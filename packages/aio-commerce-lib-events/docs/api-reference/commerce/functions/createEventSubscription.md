...
| `params`                     | \{ `destination?`: `string`; `fields`: \{ `name`: `string`; `source?`: `string`; \}[]; `force?`: `boolean`; `hipaaAuditRequired?`: `boolean`; `name`: `string`; `parent?`: `string`; `prioritary?`: `boolean`; `providerId?`: `string`; `rules?`: \{ `field`: `string`; `operator`: `string`; `value`: `string`; \}[]; \} | The parameters to create the event subscription with.                                                                                                                                              |
| `params.destination?`        | `string`                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                  |
| `params.fields?`             | \{ `name`: `string`; `source?`: `string`; \}[]                                                                                                                                                                                                                                                                            | Array of field objects, each containing a `name` property and an optional `source` property.                                                                                                       |
...
| `params.rules?`              | \{ `field`: `string`; `operator`: `string`; `value`: `string`; \}[]                                                                                                                                                                                                                                                       | Optional array of filtering rules.                                                                                                                                                                 |
