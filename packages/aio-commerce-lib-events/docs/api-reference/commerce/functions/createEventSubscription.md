...
Defined in: [commerce/api/event-subscriptions/endpoints.ts:50](https://github.com/adobe/aio-commerce-sdk/blob/bee3eb8c11aa154d3874c063d578f589fe268ddf/packages/aio-commerce-lib-events/source/commerce/api/event-subscriptions/endpoints.ts#L50)
...
| `params`                       | \{ `destination?`: `string`; `fields`: \{ `name`: `string`; `source?`: `string`; \}[]; `force?`: `boolean`; `hipaa_audit_required?`: `boolean`; `name`: `string`; `parent?`: `string`; `priority?`: `boolean`; `providerId?`: `string`; `rules?`: \{ `field`: `string`; `operator`: `"regex"` \| `"greaterThan"` \| `"lessThan"` \| `"equal"` \| `"in"` \| `"onChange"`; `value`: `string`; \}[]; \} | The parameters to create the event subscription with.                                                                                                                                              |
