...
Defined in: [commerce/api/event-subscriptions/endpoints.ts:58](https://github.com/adobe/aio-commerce-sdk/blob/c4d8d960809a7ee71cdf5efeed1e53485edd3792/packages/aio-commerce-lib-events/source/commerce/api/event-subscriptions/endpoints.ts#L58)
...
| `params`                       | \{ `destination?`: `string`; `fields`: \{ `name`: `string`; `source?`: `string`; \}[]; `force?`: `boolean`; `hipaa_audit_required?`: `boolean`; `name`: `string`; `parent?`: `string`; `priority?`: `boolean`; `provider_id?`: `string`; `rules?`: \{ `field`: `string`; `operator`: `"regex"` \| `"in"` \| `"greaterThan"` \| `"lessThan"` \| `"equal"` \| `"onChange"`; `value`: `string`; \}[]; \} | The parameters to create the event subscription with.                                                                                                                                              |
