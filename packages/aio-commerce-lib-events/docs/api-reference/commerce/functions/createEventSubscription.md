...
| `params`                     | \{ `destination?`: `string`; `fields`: \{ `name`: `string`; \}[]; `force?`: `boolean`; `hipaaAuditRequired?`: `boolean`; `name`: `string`; `parent?`: `string`; `prioritary?`: `boolean`; `providerId?`: `string`; `rules?`: \{ `field`: `string`; `operator`: `string`; `value`: `string`; \}[]; \} | The parameters to create the event subscription with.                                                                                                                                              |
| `params.destination?`        | `string`                                                                                                                                                                                                                                                                                             | -                                                                                                                                                                                                  |
| `params.fields?`             | \{ `name`: `string`; \}[]                                                                                                                                                                                                                                                                            | Array of field objects, each containing only the `name` property.                                                                                                                                  |
