...
- **`src/commerce-extensibility-1/`** and **`src/commerce-configuration-1/`** — auto-generated by `aio app build`. Do not add custom code here; changes will be overwritten on the next build.
