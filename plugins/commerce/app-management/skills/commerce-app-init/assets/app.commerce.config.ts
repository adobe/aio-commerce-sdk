...
export default defineConfig({
  metadata: {
    ...
    upgradeMode: "manual", // optional; currently defaults to "manual" while upgrade execution stabilizes (will default to "auto" once ready); "auto" runs upgrades after deploy, "manual" returns the plan without executing it
