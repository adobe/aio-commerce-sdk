...
and delegates all shell wiring to `createExtensionApp` from `@adobe/aio-commerce-lib-admin-ui/web`:
...
import { createExtensionApp } from "@adobe/aio-commerce-lib-admin-ui/web";
import { MainPage } from "./components/main-page";
import { BulkCancelPage } from "./components/bulk-cancel-page";
...
`src/components/main-page.jsx`. Merging generated content with developer-authored content in a
