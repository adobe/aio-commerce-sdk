...
| [getProjectRootDirectory](functions/getProjectRootDirectory.md)                 | Finds the project root from the nearest ancestor package.json.                                                               |
...
| [makeOutputDirFor](functions/makeOutputDirFor.md)                               | Creates an output directory relative to the project root.                                                                    |
