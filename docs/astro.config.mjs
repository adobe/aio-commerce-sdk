                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-api/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-app/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-auth/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-config/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-core/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-events/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
                  ...
                  items: [
                    {
                      autogenerate: {
                        directory:
                          "packages/aio-commerce-lib-webhooks/api-reference",
                        collapsed: true,
                      },
                    },
                  ],
