...
| [DataResidencyRegion](type-aliases/DataResidencyRegion.md)                                             | The data residency region of the event provider.                                                                           |
| [DeleteEventMetadataForProviderParams](type-aliases/DeleteEventMetadataForProviderParams.md)           | The schema of the parameters received by the DELETE `providers/:id/eventmetadata/:code` Adobe I/O Events API endpoint.     |
...
| [EventProviderDeleteParams](type-aliases/EventProviderDeleteParams.md)                                 | The schema of the parameters received by the DELETE `providers/:id` Adobe I/O Events API endpoint.                         |
...
| [EventProviderType](type-aliases/EventProviderType.md)                                                 | Defines either a Commerce or 3rd Party Custom Events provider.                                                             |
...
| [DataResidencyRegionSchema](variables/DataResidencyRegionSchema.md)                                       | -                                                                                                                      |
| [DeleteEventMetadataForProviderSchema](variables/DeleteEventMetadataForProviderSchema.md)                 | The schema of the parameters received by the DELETE `providers/:id/eventmetadata/:code` Adobe I/O Events API endpoint. |
...
| [EventProviderDeleteParamsSchema](variables/EventProviderDeleteParamsSchema.md)                           | -                                                                                                                      |
...
| [EventProviderTypeSchema](variables/EventProviderTypeSchema.md)                                           | -                                                                                                                      |
...
| [deleteEventMetadataForProvider](functions/deleteEventMetadataForProvider.md)           | Deletes event metadata for a specific event code and provider.                                                                |
| [deleteEventProvider](functions/deleteEventProvider.md)                                 | Deletes an event provider.                                                                                                    |
